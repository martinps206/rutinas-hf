...
FORMATO DE SALIDA (solo texto plano, sin markdown, sin asteriscos, sin corchetes, listo para WhatsApp):
Empezá con un encabezado tipo:
🏃 PLANILLA HÁBITO RUNNING
👤 [Nombre]
📅 Semana 1 y 2

Luego cada día con emojis y texto claro. Usá línea en blanco entre días. Terminá con una despedida cálida y la nota motivacional si la hay.`;
